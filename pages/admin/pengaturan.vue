                ...
                <div class="row">
                  <div class="col-md-6">
                    <form @submit.prevent="updateSetting">
                      <div v-if="statusSuccessUpdate" class="alert alert-success alert-dismissible my-3 small">
                        <button @click="() => statusSuccessUpdate = false" class="btn-close small"></button>
                        Pengaturan berhasil disimpan.</div>
                      <div class="my-3">
              ...
              <div class="tab-pane" id="pengaturan-pernyataan" role="tabpanel">
                <form @submit.prevent="updateSetting">
                  ...
                  <div class="my-3">
                    ...
                    <textarea v-model="setting.pernyataan_siswa" id="pernyataan" rows="8" class="form-control" placeholder="Tulis teks pernyataan siswa sebelum memeriksa hasil kelulusan..." required></textarea>
                  </div>
                  <button class="btn btn-dark" :disabled="isSaving">
                    <span v-if="isSaving">Sedang menyimpan</span>
                    <span velse>Simpan</span>
